...
# in principle one can select the device automatically with the following line of code:
#device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
# however, if you have a CUDA anabled GPU that is too old, this will result in an error.
# so I prefer to set the device manually. Choose either "cpu" or "gpu", depending on your system
